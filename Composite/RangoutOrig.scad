...
use <Boom.scad>;
use <../Parts/experiments/Grot.scad>;
use <../Parts/experiments/Staksel.scad>;
use <../Parts/Upor.scad>;
...
//okovaLevel = 0;// 4099.5 - 100;//+100;

okovaLevel = 4000 + blockHoleLevel + blokHoleH + okovaRise; // = 4099.5
            // 2 колена + …
