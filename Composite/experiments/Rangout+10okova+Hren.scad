...
//genH = okovaLevel-100 + 560.5; // оригинальный уровень - для генуи
genH = okovaLevel-100 + 560.5 + 400; // на 40 см выше - для штиляки
...
//    dz = -okovaLevel - pyrTopOffsetZ - mastPyrOffsetZ;
    //- pyrTopOffsetZ; //- 300;
//    - 5300;
//    dz = -genH - pyrTopOffsetZ - mastPyrOffsetZ;
    dz = 0;
...
*/  
    //Генакер
    translate([mastDia/2 + 15, 0 , genH-2150 ])
    Genaker();
}
